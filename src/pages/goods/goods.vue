...
import type { SkuPopupLocaldata, SkuPopupInstanceType, SkuPopupEvent } from '@/components/vk-data-goods-sku-popup/vk-data-goods-sku-popup'
...
const getGoodsDataById = async () => {
  ...
  let res = await getGoods(query.id)
      ...
      <view class="preview">
        <swiper circular @change="onSwiperChange">
          <swiper-item v-for="item in goods.mainPictures" :key="item">
            <image mode="aspectFill" :src="item" @tap="onTapPreview(item)" />
          </swiper-item>
        </swiper>
